...
import hobbyteca.controlador.ControladorAgregarSeries;
 ...
 * @author jesus
 */
public class AgregarMiListaSeries extends javax.swing.JDialog {

    private ControladorAgregarSeries controladorSeries;
    private DefaultListModel jList;
    private String datosLis[];
    private int tamannoLista;
    private Principal vistaPrincipal;
    /**
     * Creates new form AgregarSeries
     * @param parent
     * @param modal
     */
    public AgregarMiListaSeries(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controladorSeries = new ControladorAgregarSeries(this);

        try {
            jList = controladorSeries.LLenarLista(jListBuscador);
            ...
            Logger.getLogger(AgregarMiListaSeries.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//recorremos nuestro arreglo 
    ...
    private void jTextFieldBuscadorCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextFieldBuscadorCaretUpdate
        controladorSeries.filtrarLista(jList, datosLis, tamannoLista);
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
       if (jListBuscador.getSelectedIndex()!= -1){ 
        ...
        try {
            if (controladorSeries.insertarSerieMiLista(valorSeleccionado)) {
...
//recorremos nuestro arreglo 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarMiListaSeries.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarMiListaSeries dialog = new AgregarMiListaSeries(new javax.swing.JFrame(), true);
