...
import hobbyteca.controlador.ControladorAgregarManga;
 ...
 * @author jesus
 */
public class AgregarMiListaMangas extends javax.swing.JDialog {

    private ControladorAgregarManga controladorMangas;
     ...
     * @param modal
     */
    public AgregarMiListaMangas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controladorMangas = new ControladorAgregarManga(this);

        try {
            jList = controladorMangas.LLenarLista(jListBuscador);
            ...
            Logger.getLogger(AgregarMiListaMangas.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//recorremos nuestro arreglo 
    ...
    private void jTextFieldBuscadorCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextFieldBuscadorCaretUpdate
        controladorMangas.filtrarLista(jList, datosLis, tamannoLista);
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
       if (jListBuscador.getSelectedIndex()!= -1){ 
        ...
        try {
            if (controladorMangas.insertarMangaMiLista(valorSeleccionado)) {
...
//recorremos nuestro arreglo 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarMiListaMangas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarMiListaMangas dialog = new AgregarMiListaMangas(new javax.swing.JFrame(), true);
