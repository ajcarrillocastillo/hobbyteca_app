...
import hobbyteca.controlador.ControladorAgregarPeliculas;
 ...
 * @author jesus
 */
public class AgregarMiListaPeliculas extends javax.swing.JDialog {

    private ControladorAgregarPeliculas controladorPeliculas;
     ...
     * @param modal
     */
    public AgregarMiListaPeliculas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controladorPeliculas = new ControladorAgregarPeliculas(this);

        try {
            jList = controladorPeliculas.LLenarLista(jListBuscador);
            ...
            Logger.getLogger(AgregarMiListaPeliculas.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//recorremos nuestro arreglo 
    ...
    private void jTextFieldBuscadorCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextFieldBuscadorCaretUpdate
        controladorPeliculas.filtrarLista(jList, datosLis, tamannoLista);
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
       ...
       try {
            if (controladorPeliculas.insertarPeliculaMiLista(valorSeleccionado)) {
...
//recorremos nuestro arreglo 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarMiListaPeliculas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarMiListaPeliculas dialog = new AgregarMiListaPeliculas(new javax.swing.JFrame(), true);
