...
import hobbyteca.controlador.ControladorAñadirPelicula;
...
public class AñadirPelicula extends javax.swing.JDialog {
    ...
    private final ControladorAñadirPelicula controladorAñadirPelicula;
    ...
    public AñadirPelicula(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controladorAñadirPelicula = new ControladorAñadirPelicula(this);
...
//creamos un modeloDeCombobox 
    ...
    private void jTextAreaDescripcionCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextAreaDescripcionCaretUpdate
        controladorAñadirPelicula.contadorTextArea();
    ...
    private void jTextAreaDescripcionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextAreaDescripcionKeyTyped
        controladorAñadirPelicula.caracteresMaximosTextArea(evt, 3000, jTextAreaDescripcion);
    ...
    private void jTextFieldTituloKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldTituloKeyTyped
        controladorAñadirPelicula.caracteresMaximos(evt, 100, jTextFieldTitulo);
    ...
    private void jTextFieldDirectorKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDirectorKeyTyped
        controladorAñadirPelicula.caracteresMaximos(evt, 100, jTextFieldDirector);
    ...
    private void jTextFieldProdutoraKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldProdutoraKeyTyped
        controladorAñadirPelicula.caracteresMaximos(evt, 100, jTextFieldProdutora);
    ...
    private void jTextFieldTrailerKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldTrailerKeyTyped
        controladorAñadirPelicula.caracteresMaximos(evt, 300, jTextFieldTrailer);
    ...
    private void jButtonAnnadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAnnadirActionPerformed
        ...
        String trailer = jTextFieldTrailer.getText();
            ...
            switch (controladorAñadirPelicula.comprobarCamposRellenos(titulo, director, productora, descripcion, trailer)) {
                case 0:
                    JOptionPane.showMessageDialog(this, "Rellene todos los campos correctamente", "Error", JOptionPane.ERROR_MESSAGE);
                    break;
                case 1: {
                    try {
                        if (controladorAñadirPelicula.insertarPelicula(titulo, director, productora, lanzamiento, genero, descripcion, null)) {
                        ...
                        Logger.getLogger(AñadirPelicula.class.getName()).log(Level.SEVERE, null, ex);//borrar antes de entregar
                    }
                }
                ...
                case 2: {
                    try {
                        if (controladorAñadirPelicula.insertarPelicula(titulo, director, productora, lanzamiento, genero, descripcion, trailer)) {
