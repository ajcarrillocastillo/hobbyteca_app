...
import hobbyteca.controlador.ControladorAgregarVideojuego;
 ...
 * @author jesus
 */
public class AgregarMiListaVideojuego extends javax.swing.JDialog {

    private ControladorAgregarVideojuego controladorVideojuego;
    private DefaultListModel jList;
    private String datosLis[];
    private int tamannoLista;
    private Principal vistaPrincipal;
    /**
     * Creates new form AgregarVideojuegoss
     * @param parent
     * @param modal
     */
    public AgregarMiListaVideojuego(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controladorVideojuego = new ControladorAgregarVideojuego(this);

        try {
            jList = controladorVideojuego.LLenarLista(jListBuscador);
            ...
            Logger.getLogger(AgregarMiListaVideojuego.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//recorremos nuestro arreglo 
    ...
    private void jTextFieldBuscadorCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextFieldBuscadorCaretUpdate
        controladorVideojuego.filtrarLista(jList, datosLis, tamannoLista);
...
if (jListBuscador.getSelectedIndex()!= -1){
        ...
        try {
            if (controladorVideojuego.insertarVideojuegoMiLista(valorSeleccionado)) {
...
//recorremos nuestro arreglo 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarMiListaVideojuego.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarMiListaVideojuego dialog = new AgregarMiListaVideojuego(new javax.swing.JFrame(), true);
