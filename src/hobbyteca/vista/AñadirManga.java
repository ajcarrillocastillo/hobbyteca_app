...
import hobbyteca.controlador.ControladorAñadirManga;
 ...
 * @author jesus
 */
public class AñadirManga extends javax.swing.JDialog {

    private final ControladorAñadirManga controladorAñadirManga;

    /**
     * Creates new form AñadirManga
     * @param parent
     * @param modal
     */
    public AñadirManga(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controladorAñadirManga = new ControladorAñadirManga(this);
...
//creamos un modeloDeCombobox 
        ...
        for( int fechaInicio=1862;fechaInicio<=annoActual;fechaInicio++){
    ...
    private void initComponents() {
        ...
        jLabelTomosTotales = new javax.swing.JLabel();
        jTextFieldTomosTotales = new javax.swing.JTextField();
        ...
        jComboBoxGenero.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "romance", "drama", "deportes", "escolar", "shoujo", "shounen", "action", "gore", "ecchi", "superpoderes", "seinen" }));
        ...
        jLabelTomosTotales.setText("*TomosTotales");

        jTextFieldTomosTotales.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldTomosTotalesKeyTyped(evt);
            }
        });
                ...
                .addGroup(jPanelContenedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelContenedorLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelContenedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jLabelTomosTotales))
                        ...
                        .addGroup(jPanelContenedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextFieldTomosTotales, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanelContenedorLayout.setVerticalGroup(
            ...
            .addGroup(jPanelContenedorLayout.createSequentialGroup()
                ...
                .addGroup(jPanelContenedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelTomosTotales)
                    .addComponent(jTextFieldTomosTotales, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
                .addComponent(jLabelMensage)
                .addGap(18, 18, 18)
                .addGroup(jPanelContenedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jTextAreaDescripcionCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextAreaDescripcionCaretUpdate
        controladorAñadirManga.contadorTextArea();
    ...
    private void jTextAreaDescripcionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextAreaDescripcionKeyTyped
        controladorAñadirManga.caracteresMaximosTextArea(evt, 3000, jTextAreaDescripcion);
    ...
    private void jTextFieldTituloKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldTituloKeyTyped
        controladorAñadirManga.caracteresMaximos(evt, 100, jTextFieldTitulo);
    ...
    private void jTextFieldDirectorKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDirectorKeyTyped
        controladorAñadirManga.caracteresMaximos(evt, 100, jTextFieldDirector);
    ...
    private void jTextFieldProdutoraKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldProdutoraKeyTyped
        controladorAñadirManga.caracteresMaximos(evt, 100, jTextFieldProdutora);
    ...
    private void jButtonAnnadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAnnadirActionPerformed
        ...
        String tomosTotales=jTextFieldTomosTotales.getText();
        
            switch (controladorAñadirManga.comprobarCamposRellenos(titulo, director, productora, descripcion,tomosTotales )) {
                case 0:
                ...
                case 2: {
                    try {
                        if (controladorAñadirManga.insertarManga(titulo, director, productora, lanzamiento, genero, descripcion,tomosTotales)) {
                        ...
                        Logger.getLogger(AñadirManga.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                
                //guardarMangaConTrailer
                break;
                case 3:
    ...
    private void jTextFieldTomosTotalesKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldTomosTotalesKeyTyped
       controladorAñadirManga.caracteresMaximos(evt, 5, jTextFieldTomosTotales);
       controladorAñadirManga.limitarNumeros(evt);
    }//GEN-LAST:event_jTextFieldTomosTotalesKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirManga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AñadirManga dialog = new AñadirManga(new javax.swing.JFrame(), true);
    ...
    public JTextField getjTextFieldTomosTotales() {
        return jTextFieldTomosTotales;
    }

    public void setjTextFieldTomosTotales(JTextField jTextFieldTomosTotales) {
        this.jTextFieldTomosTotales = jTextFieldTomosTotales;
    }
    ...
    private javax.swing.JLabel jLabelTomosTotales;
    ...
    private javax.swing.JTextField jTextFieldTomosTotales;
