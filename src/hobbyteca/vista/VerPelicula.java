...
import hobbyteca.controlador.ControladorVerPelicula;
 ...
 * @author jesus
 */
public class VerPelicula extends javax.swing.JDialog {
    /**
     * Creates new form VerPelicula
     */
    private final ControladorVerPelicula controladorVerPelicula;
    public VerPelicula(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controladorVerPelicula=new ControladorVerPelicula(this);
        controladorVerPelicula.rellenarDatos();
    ...
    private void jButtonAplicarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAplicarActionPerformed
       ...
       int visto;
        ...
        try { 
            controladorVerPelicula.guardarActualizacion(valoracion,recomendado, visto);
            ...
            Logger.getLogger(VerPelicula.class.getName()).log(Level.SEVERE, null, ex);
        }
        controladorVerPelicula.rellenarDatos();
    }//GEN-LAST:event_jButtonAplicarActionPerformed

    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
              if (jLabelTitulo.getText().contains("Star Wars")) {
            AudioClip sonido;
            java.applet.Applet.newAudioClip(getClass().getResource("../sonido/light-saber-off.wav")).play();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerPelicula dialog = new VerPelicula(new javax.swing.JFrame(), true);
