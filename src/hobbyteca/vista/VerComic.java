...
import hobbyteca.controlador.ControladorVerComic;
 ...
 * @author jesus
 */
public class VerComic extends javax.swing.JDialog {
    /**
     * Creates new form VerComic
     */
    
    private final ControladorVerComic controladorVerComic;
    public VerComic(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controladorVerComic=new ControladorVerComic(this);
        controladorVerComic.rellenarDatos();
    ...
    private void jButtonAplicarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAplicarActionPerformed
       ...
       int recomendado;  
       String capitulosVistos=jComboBoxCapitulosVistos.getSelectedItem()+"";
        ...
        try { 
            controladorVerComic.guardarActualizacion(valoracion,recomendado, capitulosVistos);
            ...
            Logger.getLogger(VerComic.class.getName()).log(Level.SEVERE, null, ex);
        }
        controladorVerComic.rellenarDatos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerComic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerComic dialog = new VerComic(new javax.swing.JFrame(), true);
